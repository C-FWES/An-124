		...
		if ((getprop("services/fuel-truck/enable") == 1) and (getprop("services/fuel-truck/connect") == 1)) {
			...
			if (getprop("/services/fuel-truck/transfer")) {
				...
				if (getprop("consumables/fuel/total-fuel-lbs") < getprop("/services/fuel-truck/request-lbs")) {
					...
					if (getprop("consumables/fuel/tank/level-lbs") < 82088) {

						setprop("/consumables/fuel/tank/level-lbs", getprop("/consumables/fuel/tank/level-lbs") + 30);
					}

					if (getprop("consumables/fuel/tank[1]/level-lbs") < 72088) {

						setprop("/consumables/fuel/tank[1]/level-lbs", getprop("/consumables/fuel/tank[1]/level-lbs") + 30);
					}

					if (getprop("consumables/fuel/tank[2]/level-lbs") < 52088) {

						setprop("/consumables/fuel/tank[2]/level-lbs", getprop("/consumables/fuel/tank[2]/level-lbs") + 30);

					}
					if (getprop("consumables/fuel/tank[3]/level-lbs") < 32088) {

						setprop("/consumables/fuel/tank[3]/level-lbs", getprop("/consumables/fuel/tank[3]/level-lbs") + 30);

					}
					if (getprop("consumables/fuel/tank[4]/level-lbs") < 22088) {

						setprop("/consumables/fuel/tank[4]/level-lbs", getprop("/consumables/fuel/tank[4]/level-lbs") + 30);

					}
					if (getprop("consumables/fuel/tank[5]/level-lbs") < 82088) {

						setprop("/consumables/fuel/tank[5]/level-lbs", getprop("/consumables/fuel/tank[5]/level-lbs") + 30);

					}
					if (getprop("consumables/fuel/tank[6]/level-lbs") < 72088) {

						setprop("/consumables/fuel/tank[6]/level-lbs", getprop("/consumables/fuel/tank[6]/level-lbs") + 30);

					}
					if (getprop("consumables/fuel/tank[7]/level-lbs") < 52088) {

						setprop("/consumables/fuel/tank[7]/level-lbs", getprop("/consumables/fuel/tank[7]/level-lbs") + 30);

					}
					if (getprop("consumables/fuel/tank[8]/level-lbs") < 32088) {

						setprop("/consumables/fuel/tank[8]/level-lbs", getprop("/consumables/fuel/tank[8]/level-lbs") + 30);

					}
					if (getprop("consumables/fuel/tank[9]/level-lbs") < 22088) {

						setprop("/consumables/fuel/tank[9]/level-lbs", getprop("/consumables/fuel/tank[9]/level-lbs") + 30);
			...
			if (getprop("/services/fuel-truck/clean")) {
				...
				if (getprop("consumables/fuel/total-fuel-lbs") > 90) {
					...
					setprop("/consumables/fuel/tank[5]/level-lbs", getprop("/consumables/fuel/tank[5]/level-lbs") - 80);
					setprop("/consumables/fuel/tank[6]/level-lbs", getprop("/consumables/fuel/tank[6]/level-lbs") - 80);
					setprop("/consumables/fuel/tank[7]/level-lbs", getprop("/consumables/fuel/tank[7]/level-lbs") - 80);
					setprop("/consumables/fuel/tank[8]/level-lbs", getprop("/consumables/fuel/tank[8]/level-lbs") - 80);
					setprop("/consumables/fuel/tank[9]/level-lbs", getprop("/consumables/fuel/tank[9]/level-lbs") - 80);
