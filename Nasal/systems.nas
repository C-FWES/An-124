...
aircraft.livery.init("Aircraft/An-124/Models/Liveries");
...
#		setprop("consumables/fuel/tank[2]/level-gal_us", capaux);
...
#		setprop("consumables/fuel/tank[6]/level-gal_us", capaux);
#		setprop("consumables/fuel/tank[7]/level-gal_us", capaux);
#		setprop("consumables/fuel/tank[8]/level-gal_us", capaux);
#            total_fuel -= (capaux * 3);
#        }
#        else
#        {
...
controls.toggleExtraLights = func()
{
    var state = getprop("controls/lighting/landing-light[3]");
    setprop("controls/lighting/landing-light[2]",!state);
    setprop("controls/lighting/landing-light[3]",!state);
}
